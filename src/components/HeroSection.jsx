            ...
            <div className="container mx-auto px-4 flex flex-col-reverse md:flex-row items-center justify-between gap-10">
                ...
                <div className="md:w-1/2 text-center md:text-left">
                    ...
                    <p className="text-lg text-white mb-8">
                        Send money from the UK, EU, US, UAE, Canada and Australia to Africa, Asia, the Caribbean
                        and Latin America at a great rate. With fast transfers to mobile money wallets on popular
                        networks, you can send money from your smartphone anytime.
                    </p>
